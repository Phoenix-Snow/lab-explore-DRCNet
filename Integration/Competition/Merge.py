...
from Preprocess.Calculate import calculate_solar_radiation, trans_LonLat2CCDEM
from Preprocess.Excel2CSV import excel2csv
from Preprocess.Imputation import Imputation
...
class MergeByYaml:
    ...
    def work(self, time_series_len=None, spatial_target_size=None):
        # 加载配置
